  ...
  return (
    <form
      action={async (data: FormData) =>
        window.confirm("Are you sure you want to delete your AI?") &&
        deleteAi(data, id, "delete")
          .then(async (res) => {
            if (res.error) {
    ...
    >
      <div className="relative flex flex-col space-y-4 p-5 sm:p-10">
        <h2 className="font-cal text-xl dark:text-white">Delete AI</h2>
        <p className="text-sm text-stone-500 dark:text-stone-400">
          Deletes your AI and all knowledge associated with it. Type in the name
          of your AI <b>{aiName}</b> to confirm.
        </p>
